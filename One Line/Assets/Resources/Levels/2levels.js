...
// index es el numero del nivel, 100 para cada tipo

// layout muestra el contenido inicial del mapa, 0 es vacio, 1 es casilla y 2 indica el origen,
// cada string es una fila, todas tienen el mismo tamaño, numero de columnas, que no aparece codificado

// path muestra el camino correcto, su longitud seria el numero de 1 y 2 en el layout(casillas del nivel)
// cada punto por el que se pasa se muestra con sus coordenadas (siempre son adyacentes) 0,0 es la esquina
// superior izqueirda, la inferior derecha nFilas, nColumnas
